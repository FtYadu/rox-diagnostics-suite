...
import { RoutinePanel } from "@/features/processes/routine-panel";
...
function EcuDetailPage() {
  ...
  const canClear = canPerform(role, "clear-dtc");
        ...
        actions={
          <>
            ...
            <Button asChild variant="secondary" className="rounded-full">
              <Link to="/ecus/$ecuId/io-control" params={{ ecuId: ecu.id }}>
                <SlidersHorizontal className="size-4" />
                IO control
              </Link>
            </Button>
            <Button asChild variant="secondary" className="rounded-full">
              <Link to="/ecus/$ecuId/configuration" params={{ ecuId: ecu.id }}>
            ...
            <Button
              ...
              title={canClear ? undefined : roleTooltip("clear-dtc")}
            >
              ...
              {(identification.data ?? []).map((entry) => (
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    {entry.expected && entry.expected !== entry.value && (
                      <span className="rounded-full bg-warning/15 px-2 py-1 text-[11px] font-medium text-warning">
                    ...
                    <p className="font-mono text-sm numerals">{entry.value}</p>
                    <Button
                      variant="ghost"
                      size="icon"
